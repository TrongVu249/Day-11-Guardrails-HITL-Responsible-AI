...
def content_filter(response: str) -> dict:
    ...
    PII_PATTERNS = {
        ...
        "Internal DB host": r"\b[\w.-]+\.internal\b(?::\d+)?",
    }
...
class OutputGuardrailPlugin(base_plugin.BasePlugin):
    ...
    async def after_model_callback(
        ...
        *,
        ...
        # 1. Content filter — redact PII / secrets if any are found
        ...
        # 2. LLM-as-Judge — block entirely if judged unsafe
                ...
                llm_response.content = types.Content(
                    ...
                    parts=[types.Part.from_text(
                        text="I'm sorry, but I can't share that information. "
                             "Is there something else about your banking I can help with?"
                    )],
                )
